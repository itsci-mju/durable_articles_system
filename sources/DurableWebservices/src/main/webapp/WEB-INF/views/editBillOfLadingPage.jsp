...
<body>
	...
	<div class="row" style="margin-top: 70px">
		<div class="container">
			<form action="do_editBillOfLading" name="billOfLading"
					...
					<div class="panel-body">
									...
									<div class="row" style="margin: 10px">
										...
										<div class="form-group">
											<label class="col-sm-5 control-label">รหัสแผนงาน : </label> <label
												class="col-sm-5 control-label">${ bill_of_lading.getPlan_id() }</label>
										</div>
										<div class="form-group">
											<label class="col-sm-5 control-label">รหัสหน่วยงาน :
											</label> <label class="col-sm-5 control-label">${ bill_of_lading.getDepart_id() }
											</label>
										</div>
										<div class="form-group">
											<label class="col-sm-5 control-label">รหัสกองทุน : </label> <label
												class="col-sm-5 control-label">${ bill_of_lading.getFund_id() }</label>
										</div>
										<div class="form-group">
											<label class="col-sm-5 control-label">ใช้เงิน : </label> <label
												class="col-sm-5 control-label">${ bill_of_lading.getMoney_used() }
											</label>
										</div>
									</div>
								</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" id="billOfLading_id"
													...
													class="form-control" value="${ bill_of_lading.getBillOfLading_id() }" readonly ="readonly"> <input type="hidden"
													id="doc_id" name="doc_id"
													value="${ bill_of_lading.getDoc_id()}">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-5 control-label">แผนงาน : </label> <label
												class="col-sm-5 control-label">${ bill_of_lading.getPlan_name() }</label>
										</div>
										<div class="form-group">
											<label class="col-sm-5 control-label">หน่วยงาน : </label> <label
												class="col-sm-5 control-label">${ bill_of_lading.getDepart_name() }</label>
										</div>
										<div class="form-group">
											<label class="col-sm-5 control-label">กองทุน : </label> <label
												class="col-sm-5 control-label">${ bill_of_lading.getFund_name() }
											</label>
										</div>
										<div class="form-group">
											<label class="col-sm-5 control-label">งาน : </label> <label
												class="col-sm-5 control-label">${ bill_of_lading.getWork_name() }</label>
										</div>
										<div class="form-group">
											<label class="col-sm-5 control-label">งบ : </label> <label
												class="col-sm-5 control-label">${ bill_of_lading.getBudget() }</label>
										</div>
										<!-- 										<div class="form-group"> -->
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								<div class="table-responsive">
									<table border="1" id="tableform">
										...
										<c:forEach
											items="${ bill_of_lading.getRequisitionItemLists() }"
										...
										<tr>
											...
											<td style="text-align: center"><fmt:formatNumber
													type="number" minFractionDigits="2" maxFractionDigits="2"
													value="${ bill_of_lading.getPrice_with_out_tax() }" /></td>
											<td></td>
										</tr>
										<tr>
											...
											<td style="text-align: center"><fmt:formatNumber
													type="number" minFractionDigits="2" maxFractionDigits="2"
													value="${ bill_of_lading.getTax() }" /></td>
											<td></td>
										</tr>
										<tr>
											...
											<td style="text-align: center"><fmt:formatNumber
													type="number" minFractionDigits="2" maxFractionDigits="2"
													value="${ bill_of_lading.getTotal_price() }" /></td>
											<td>บาท</td>
										</tr>
									</table>
								</div>
						...
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-12"
								...
								<label>${ bill_of_lading.getPrice_txt() }</label>
							</div>
						</div>
						<!-- signature -->
										...
										<div class="col-sm-6">
											<select class="form-control" id="doc_4_1"
												...
												<c:forEach items="${ doc_4_1 }" var="doc_4_1">
													<option <c:if test="${ doc_4_1.getPersonnelAssign().getPersonnel().getPersonnel_id() == bill_of_lading.getBill_of_lading_1() }">selected</c:if>
													 value="${ doc_4_1.getPersonnelAssign().getPersonnel().getPersonnel_id() }">${ doc_4_1.getPersonnelAssign().getPersonnel().getPersonnel_prefix() }
										...
										<div class="col-sm-6">
											<select class="form-control" id="doc_4_2"
												...
												<c:forEach items="${ doc_4_2 }" var="doc_4_2">
													<option
													<c:if test="${ doc_4_2.getPersonnelAssign().getPersonnel().getPersonnel_id() == bill_of_lading.getBill_of_lading_2() }">selected</c:if>
													 value="${ doc_4_2.getPersonnelAssign().getPersonnel().getPersonnel_id() }">${ doc_4_2.getPersonnelAssign().getPersonnel().getPersonnel_prefix() }
											...
											<div class="col-sm-6">
												<select class="form-control" id="doc_4_3"
													...
													<c:forEach items="${ doc_4_3 }" var="doc_4_3">
														<option
														<c:if test="${ doc_4_3.getPersonnelAssign().getPersonnel().getPersonnel_id() == bill_of_lading.getReceive_person() }">selected</c:if>
														 value="${ doc_4_3.getPersonnelAssign().getPersonnel().getPersonnel_id() }">${ doc_4_3.getPersonnelAssign().getPersonnel().getPersonnel_prefix() }
										...
										<div class="col-sm-6">
											<select class="form-control" id="doc_4_5"
												...
												<c:forEach items="${ doc_4_5 }" var="doc_4_5">
													<option	<c:if test="${ doc_4_5.getPersonnelAssign().getPersonnel().getPersonnel_id() == bill_of_lading.getBill_of_lading_5() }">selected</c:if>
										...
										<div class="col-sm-6">
											<select class="form-control" id="doc_4_4"
												...
												<c:forEach items="${ doc_4_4 }" var="doc_4_4">
													<option <c:if test="${ doc_4_4.getPersonnelAssign().getPersonnel().getPersonnel_id() == bill_of_lading.getBill_of_lading_4() }">selected</c:if>
