...
Calendar prescription = Calendar.getInstance();
prescription.add(Calendar.MONTH, 1);
%>
<html>
<head>
<script
...
<meta charset="UTF-8">
<title>เพิ่มรายการเอกสารขอซื้อ/จ้าง</title>
</head>
<body>
	<jsp:include page="/WEB-INF/views/common/navbarmenu.jsp"></jsp:include>
	<div class="row" style="margin-top: 70px">
		<div class="container">
			<form action="do_addPurchaseOrderDocument" name="purchaseOrderFrm"
					...
					<div class="panel-body">
									...
									<div class="row" style="margin: 10px">
										...
										<div class="form-group">
											<label class="col-sm-5 control-label">ใช้เงิน : </label> <label
												class="col-sm-5 control-label">${ purchaseOrderRequest.getMoney_used() }
											</label>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label class="col-sm-5 control-label">เรื่อง : </label> <label
												class="col-sm-5 control-label">${ purchaseOrderRequest.getDoc_title() }
											</label>
										</div>
									</div>
								</div>
									...
									<div class="row" style="margin: 10px">
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" id="purchaseOrder_id"
													...
													value="${ purchaseOrderRequest.getDoc_id()}">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<label class="col-sm-5 control-label">กองทุน : </label> <label
												class="col-sm-5 control-label">${ purchaseOrderRequest.getFund_name() }
											</label>
										</div>
										<div class="form-group">
								...
								<div class="table-responsive">
									<table>
										...
										<tr>
											...
											<td colspan="6">${ purchaseOrderRequest.getPrice_txt() }</td>
										</tr>
									</table>
								</div>
							</div>
						...
						<div class="row">
							<div class="" style="margin: 20px">
								<div class="col-sm-12">
									<div class="form-group">
										<label class="">เหตุผล/ความจําเป็น : ${ purchaseOrderRequest.getDoc_reason_describe() }</label>
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								<div class="table-responsive">
									<table>
										...
										<c:forEach items="${ purchaseOrderRequest.getCommittee() }"
											...
											<div class="col-sm-6">
												<select class="form-control" id="doc_2_3" name="doc_2_3">
													...
													<c:forEach items="${ doc_2_3 }" var="doc_2_3">
														<option
															<c:if test="${ purchaseOrderRequest.getAccounting_officer() == doc_2_3.getPersonnelAssign().getPersonnel().getPersonnel_id() }">selected</c:if>
											...
											<div class="col-sm-6">
												<select class="form-control" id="doc_2_4" name="doc_2_4">
													...
													<c:forEach items="${ doc_2_4 }" var="doc_2_4">
														<option
															<c:if test="${ purchaseOrderRequest.getChief_of_procurement() == doc_2_4.getPersonnelAssign().getPersonnel().getPersonnel_id() }">selected</c:if>
											...
											<div class="col-sm-6">
												<select class="form-control" id="doc_2_5" name="doc_2_5">
													...
													<c:forEach items="${ doc_2_5 }" var="doc_2_5">
														<option
															<c:if test="${ purchaseOrderRequest.getSecretary() == doc_2_5.getPersonnelAssign().getPersonnel().getPersonnel_id() }">selected</c:if>
