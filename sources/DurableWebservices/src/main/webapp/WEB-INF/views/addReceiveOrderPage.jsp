...
<meta charset="UTF-8">
<title>เพิ่มใบตรวจรับพัสดุ</title>
</head>
<body>
	<jsp:include page="/WEB-INF/views/common/navbarmenu.jsp"></jsp:include>
	<div class="row" style="margin-top: 70px">
		<div class="container">
			<form action="do_addReceiveOrderDocument" name="refrm"
					...
					<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" id="receiveOrder_id"
													...
													class="form-control" value="${ purchaseOrderDoc.getPurchaseOrderDocument_id() }"> <input type="hidden"
													id="doc_id" name="doc_id"
													value="${ purchaseOrderDoc.getDoc_id()}">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" id="receiveOrderDocument_from"
													...
													value="${ purchaseOrderDoc.getStore_name() }">
											</div>
										</div>
										<div class="form-group">
									...
									<table border="1" id="tableform">
										...
										<tr>
											<td style="text-align: center" colspan="5"
												style="text-align:center">${ purchaseOrderDoc.getPrice_txt() }</td>
						...
						<div class="row" style="margin-top: 20px">
							...
							<div class="col-sm-6 col-md-6 col-lg-6">
								<fieldset>
									<legend style="font-size: 1em">
										<i class="fa fa-user" aria-hidden="true"></i> ผู้ทราบอนุมัติและเบิกจ่าย
									</legend>
									<div id="old_purchase">
										<div class="form-group">
											<label class="col-sm-3 control-label">รายชื่อ : </label>
