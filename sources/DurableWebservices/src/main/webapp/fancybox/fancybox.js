$(document).ready(
		function() {
			...
			// Set custom style, close if clicked, change title type and overlay
			// color
			...
			/*
			 * Thumbnail helper. Disable animations, hide close button, arrows
			 * and slide to next gallery item if clicked
			 */
