...
class StatusGoodPage extends StatefulWidget {
  @override
  _StatusGoodState createState() => _StatusGoodState();
}

class _StatusGoodState extends State<StatusGoodPage> {
  bool isLoading = true;
  String nameUser = "";
  String staff = "";
  Staff? s;
  ...
  void findUser() async {
    ...
    vm.listverifystatus(majorid!, year!)
        .then((value) =>
    {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('ข้อมูลครุภัณฑ์ สถานะดี',style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold)),
          leading: IconButton(
            onPressed: () {
