...
class StatusdefectivePage extends StatefulWidget {
  @override
  _StatusdefectiveState createState() => _StatusdefectiveState();
}

class _StatusdefectiveState extends State<StatusdefectivePage> {
  bool isLoading = true;
  String nameUser = "";
  String staff = "";
  Staff? s;
  ...
  void findUser() async {
    ...
    vm.listverifystatus2(majorid!, year!)
        .then((value) =>
    {
